...
{/* Same as */}
      ...
      <div className='absolute top-[65px] bg-white w-[100vw] h-[93vh] flex justify-center items-center '>
        <div className='w-2/3 h-2/3 border border-black flex rounded-lg font-serif shadow-lg shadow-green-700'>
          ...
          <div className='w-1/2 flex flex-col justify-center gap-5  '>
            ...
            <div className='flex flex-col gap-5  mx-10'>
              ...
              New user?<Link className='hover:underline' href={'/register'} >Register</Link> 
              </div>
            </div>
    ...
    className="mx-auto flex items-center w-64 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-green-100 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
...
//     <div className='absolute bg-white border-red-500 top-[65px] border-2 w-full h-[100vh] flex justify-center items-center border-none'>
...
//             <input 
//                 name="username"
//                 className='border border-black mt-[1rem] w-[25rem] h-[2.5rem] p-2 rounded-md transition duration-300 ease-in-out transform hover:scale-105 focus:scale-105'
//                 placeholder='Enter Username'
//                 onChange={(e) => setUsername(e.target.value)}
//             />
//         </div>
...
//             <button 
//                 className='border py-[0.5rem] px-[2rem] bg-green-700 text-white font-serif rounded-md transition duration-300 ease-in-out transform hover:scale-105 focus:scale-105'
//                 onClick={() => {
//                     if (formValidation()) {
//                         submitLoginDetails();
//                     }
